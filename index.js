...
const chika = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('Sofyan AMV','red'),color('X','lime'),color('MrG{108P}*','red'))
})
...
chika.on('group-participants-update', async (anu) => {
	...
	chika.on('message-new', async (amv) => {
		try {
			...
			const reply = (teks) => {
				chika.sendMessage(from, teks, text, {quoted:iky})
			}
			const sendMess = (hehe, teks) => {
				chika.sendMessage(hehe, teks, text)
			}
			const mentions = (teks, memberr, id) => {
				(id == null || id == undefined || id == false) ? chika.sendMessage(from, teks.trim(), extendedText, {contextInfo: {"mentionedJid": memberr}}) : chika.sendMessage(from, teks.trim(), extendedText, {quoted: iky, contextInfo: {"mentionedJid": memberr}})
			}
			const sendImage = (teks) => {
		    chika.sendMessage(from, teks, image, {quoted:iky})
		    }
		    ...
		    const sendPtt = (teks) => {
		    chika.sendMessage(from, audio, mp3, {quoted:iky})
		    }
	        /*****************END SCURITY FEATURE ********/
        ...
        if (levelRole <= 2) {
          ...
          const checkLimit = (sender) => {
          	let found = false
                    for (let lmt of _limit) {
                        if (lmt.id === sender) {
                            ...
                            chika.sendMessage(from, ind.limitcount(limitCounts), text, { quoted : iky})
                            found = true
                        }
                    }
                    if (found === false) {
           ...
           const isLimit = (sender) =>{ 
              ...
              if (limits >= limitawal ) {
              	  position = true
                    chika.sendMessage(from, ind.limitend(pushname), text, {quoted: iky})
                    return true
              } else {
              	_limit
                  position = true
		...
		setTimeout( () => {
			...
			switch(command) {
				case 'nobadword':  // Fix Bug By Sofyan AMV X MrG{108P}*
				...
				case 'addbadword':  // Fix Bug By Sofyan AMV X MrG{108P}*
                    ...
                    break
                case 'delbadword':  // Fix Bug By Sofyan AMV X MrG{108P}*
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    if (args.length < 1) return reply( `Kirim perintah ${prefix}addbadword [kata kasar]. contoh ${prefix}addbadword bego`)
                    ...
                    break 
                case 'listbadword':  // Fix Bug By Sofyan AMV X MrG{108P}*
                    ...
                    break 
				case 'getsticker':
				case 'gets':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					namastc = body.slice(12)
					result = fs.readFileSync(`./strg/sticker/${namastc}.webp`)
					chika.sendMessage(from, result, sticker, {quoted :iky})
					break
				case 'stickerlist':
				case 'liststicker':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					teks = '*Sticker List :*\n\n'
					...
					break
				case 'addsticker':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					...
					break
				case 'addvn':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					...
					break
				case 'getvn':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					namastc = body.slice(7)
					buffer = fs.readFileSync(`./strg/audio/${namastc}.mp3`)
					chika.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', quoted: iky, ptt: true })
					break
				case 'listvn':
				case 'vnlist':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					teks = '*List Vn:*\n\n'
					...
					break
				case 'addimage':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					...
					break
				case 'getimage':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					...
					break
				case 'imagelist':
				case 'listimage':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					teks = '*List Image :*\n\n'
					...
					break
				case 'addvideo':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					...
					break
				case 'getvideo':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					namastc = body.slice(10)
					buffer = fs.readFileSync(`./strg/video/${namastc}.mp4`)
					chika.sendMessage(from, buffer, video, { mimetype: 'video/mp4', quoted: iky })
					break
				case 'listvideo':
				case 'videolist':  // Fix Bug By Sofyan AMV X MrG{108P}*
				if (!isRegistered) return reply(ind.noregis())
					teks = '*List Video :*\n\n'
					...
					break	
				case 'kusonimesearch':
                case 'kusonime': // Fix Bug By Sofyan AMV X MrG{108P}* 		
                if (!isRegistered) return reply( ind.noregis())
                    query = args.join(" ")
                ...
                case 'flamming':
                case 'harrypotter':
                case 'carvedwood':  // Fix Bug By Sofyan AMV X MrG{108P}*
                    if (!isRegistered) return reply( ind.noregis())
                ...
                case 'freefire':  // Fix Bug By Sofyan AMV X MrG{108P}*
                    if (!isRegistered) return reply( ind.noregis())
                    if (args.length == 0) return reply('Teksnya mana um')
                    txt = args.join(" ")
                    ...
                    chika.sendMessage(from, buffer, image, { quoted: amv })
                    break
		case 'mutual': // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
				...
				break
		case 'next': // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
				if (isGroup) return  reply( 'Command ini tidak bisa digunakan di dalam grup!')
				anug = getRegisteredRandomId(_registered).replace('@s.whatsapp.net','')
				await reply('Find for a partner...')
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6281227825649@s.whatsapp.net', fee)
              ...
              case 'hii':
				...
				chika.sendMessage(from, ainecs, MessageType.audio, { quoted: amv, ptt: true })
				await limitAdd(sender)
				break
              case 'shizuka':
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, ainezz, MessageType.audio, { quoted: amv, ptt: true })
				await limitAdd(sender)
				break
              case 'soundbakahentai':
				...
				chika.sendMessage(from, aineess, audio, {mimetype: 'audio/mp4', filename: `bakahentai.mp3`, quoted: iky})
				await limitAdd(sender)
				break
              case 'sayonichan':
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, aineesi, MessageType.audio, { quoted: amv, ptt: true })
				await limitAdd(sender)
				break
              case 'soundplaydate':
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, aineesiie, MessageType.audio, { quoted: amv, ptt: true })
				await limitAdd(sender)
				break
              case 'hallo':
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, aineesii, MessageType.audio, { quoted: amv, ptt: true })
				await limitAdd(sender)
				break
                case 'admin':
				if (!isOwner) return reply(ind.ownerb())
				...
				chika.sendMessage(from, teks.trim(), extendedText, {quoted: iky, contextInfo: {"mentionedJid": adm}})
				break
                case 'premium':
				if (!isOwner) return reply(ind.ownerb())
				premm = body.slice(9)
		...
		case 'unpremium':
				...
				chika.sendMessage(from, teks.trim(), extendedText, {quoted: iky, contextInfo: {"mentionedJid": prem}})
				break
                case 'bann':
		...
		case 'unban':
				...
				chika.sendMessage(from, teks.trim(), extendedText, {quoted: iky, contextInfo: {"mentionedJid": ban}})
				break
		...
		case 'giftlimit': 
				...
				chika.sendMessage(from, buffer, image, {quoted: iky, caption: `${teks}`})
				await limitAdd(sender)
				break
		case 'happymod':
				 // Fix Bug By Sofyan AMV				
		...
		case 'shrtco':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					exec(`wget ${anu.url} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						...
						chika.sendMessage(from, buffer, sticker, {quoted: iky})
						fs.unlinkSync(rano)
					})
					await limitAdd(sender)
					break
		...
		case 'randomhentai':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					reply(ind.wait())
                                        ...
                                        chika.sendMessage(from, buffer, image, {quoted: iky})
					await limitAdd(sender)
                                        break
		case 'cium':
                                         // Fix Bug By Sofyan AMV				
		...
		case 'nulis':
				...
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: iky})
				await limitAdd(sender)
				break
		case 'nulis2':
		...
		/*case 'nulis2':
 			 ...
 			 //  reply('p\n' + util.format({fontPath, inputPath, outputPath, tgl, hari, textnulis}))
 				 ...
 				 .on('exit', () => {
  			  chika.sendMessage(from, outputPath, image, {quoted: iky, caption : ' nih sayang, jangan mager ya sayang'})
  			}))
  			  break*/
		case 'bplogo':
				 // Fix Bug By Sofyan AMV				
				...
				buffer = await getBuffer(anu.result)
				chika.sendMessage(from, buffer, image, {caption: 'Nih kak udah jadi..', quoted: iky})
				await limitAdd(sender)
				break
		case 'hartatata':
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, bh, image, {caption: 'Nih kak udah jadi..', quoted: iky})
				await limitAdd(sender)
				break
		case 'hartatata2':
		...
		case 'attp':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					chika.sendMessage(from, atytyd, sticker, {quoted: iky})
					await limitAdd(sender) 
					break
		case 'cblackpink':
				 // Fix Bug By Sofyan AMV				
		...
		case 'shota':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				    try {
						...
						chika.sendMessage(from, buffer, image, {quoted: iky, caption: 'Ingat! Cintai husbumu'})
					} catch (e) {
		...
		case 'randomkpop':
				...
				buffer = await getBuffer(anu.result)
				chika.sendMessage(from, buffer, image, {quoted: iky, caption: 'Nih kpopnya kak...'})
				await limitAdd(sender)
				break
		case 'aesthetic':
				...
				chika.sendMessage(from, buffer, image, {quoted: iky, caption: 'Nih aestheticnya kak...'})
				await limitAdd(sender)
				break
		case 'logoepep': 
				gatauda = body.slice(9)
				...
				chika.sendMessage(from, buffer, image, {quoted: iky, caption: 'Nih hasilnya kak...'})
				await limitAdd(sender)
				break
		case 'logoepep2': 
				gatauda = body.slice(10)
		...
		case 'pornlogo': 
				...
				chika.sendMessage(from, buffer, image, {quoted: iky, caption: infomp3})
				chika.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', filename: `${data.result.title}.mp3`, quoted: iky})
				await limitAdd(sender)
				break
		case 'play':   
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, lagu, audio, {mimetype: 'audio/mp4', filename: `${anu.result.title}.mp3`, quoted: iky})
				await limitAdd(sender)
				break
		/*case 'play2':   
				 // Fix Bug By Sofyan AMV				
				...
				buffer = await getBuffer(anu.result.thumbnail)
				chika.sendMessage(from, buffer, image, {quoted: iky, caption: iinfomp3})
				laguu = await getBuffer(anu.result.url)
				chika.sendMessage(from, laguu , audio, {mimetype: 'audio/mp4', filename: `${anu.result.title}.mp3`, quoted: iky})
				await limitAdd(sender)
				break*/
		case 'limit':
				 // Fix Bug By Sofyan AMV				
		...
		case 'vinta':
				...
				chika.sendMessage(from, vintage, image, {caption: 'nih anjim ${vin}', quoted: iky})
				await limitAdd(sender)
				break
		case 'avengers':
				 // Fix Bug By Sofyan AMV				
				...
				chika.sendMessage(from, aruga, image, {caption: 'Nih kak', quoted: iky})
				await limitAdd(sender)
				break 
		case 'summer':
				 // Fix Bug By Sofyan AMV				
		...
		case 'firework':
				...
				chika.sendMessage(from, arugazzz, image, {caption: 'Nih kak', quoted: iky})
				await limitAdd(sender)
				break
		case 'lava':
				 // Fix Bug By Sofyan AMV				
                ...
                case '1cak':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
						...
						chika.sendMessage(from, buffer, image, {quoted: iky, caption: 'Nih Kak udah Jadi'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply(ind.wrongf())
					}
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					await limitAdd(sender)
					break	
                case 'faktaunik': // Fixed By chikaXSec404 & RzkyO
					 // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
		...
		case 'infogempa':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					hasil = `*Potensi*\n${anu.potensi}\n*Lokasi*\n${anu.lokasi}\n*Magnitude*\n${anu.magnitude}\n*Koordinat*\n${anu.koordinat}\n*Kedalaman*\n${anu.kedalaman}\n*Waktu*\n${anu.waktu}\n*Map*\n${anu.map}`
					chika.sendMessage(from, buffer, image, {quoted: iky, caption: hasil})
					await limitAdd(sender)
					break
		case 'infocuaca':
					tels = body.slice(11)
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					chika.sendMessage(from, hasil, text, {quoted: iky})
					await limitAdd(sender)
					break
		case 'kurs': 
                 if (!isRegistered) return reply( ind.noregis())
		...
		case 'github': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					chika.sendMessage(from, buffer7, image, {quoted: iky, caption: capt})
					await limitAdd(sender)
					break
                case 'slap':
		...
		case 'brainly':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					chika.sendMessage(from, teks, text, {quoted: iky, detectLinks: false})
					console.log(res)
					})
					await limitAdd(sender)
					break 
		...
		case 'pinterest':
		   ...
		   case 'mimpi':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
			        ...
			        chika.sendMessage(from, mimpi, text, {quoted: iky })
			        await limitAdd(sender) 
			    	break
		     case 'fakta':
			         // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
					...
					chika.sendMessage(from, fakta, text, {quoted: iky })
					await limitAdd(sender) 
					break 
				case 'katabijak':
			         // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
					...
					chika.sendMessage(from, katabijak, text, {quoted: iky })
					await limitAdd(sender) 
					break
			case 'katailham':
			         // Fix Bug By Sofyan AMV				
				...
				kata = anu.result
				chika.sendMessage(from, kata, text, {quoted: iky })
				await limitAdd(sender)
				break
				case 'caklontong':
			         // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
					...
					setTimeout( () => {
					chika.sendMessage(from, caklontong, text, {quoted: iky }) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender) 
					break 
		         case 'babi':
				...
				case 'tebakgambar':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					...
					setTimeout( () => {
					chika.sendMessage(from, '*тЮ╕ Jawaban :* '+anu.jawaban, text, {quoted: iky }) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					chika.sendMessage(from, '_10 Detik lagiтАж_', text) // ur cods
					}, 20000) // 1000 = 1s,
					...
					setTimeout( () => {
					chika.sendMessage(from, bufferkkk, image, { caption: '_Jelaskan Apa Maksud Gambar Ini_', quoted: iky }) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender) 
					break  
		case 'spamcall':
			...
			chika.sendMessage(from, `${anu.result.logs}`, text, {quoted: iky })
			await limitAdd(sender) 
			break  
				case 'wiki':
			         // Fix Bug By Sofyan AMV				
                ...
                if (anu.error) return reply(anu.error)
                wikii = `${anu.result}`
                chika.sendMessage(from, wikii, text, {quoted: iky })
                await limitAdd(sender) 
                break
               case 'asupan':
			         // Fix Bug By Sofyan AMV				
                ...
                chika.sendMessage(from, asup, video, {mimetype: 'video/mp4', filename: `asupan_bangsa.mp4`, quoted: iky, caption: 'Asupannya Tuan:v'})
                await limitAdd(sender) 
                break
               case 'ytmp4':
			         // Fix Bug By Sofyan AMV				
			...
			case 'ytmp3':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					...
					chika.sendMessage(from, buffer, audio, {mimetype: 'audio/mp4', filename: `${anu.title}.mp3`, quoted: iky })
					await limitAdd(sender) 
					break
			 case 'nsfwloli':
				    try {
		...
		case 'alay2': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					reply(data.result)
				        await limitAdd(sender)
					break
		case 'fml':	// Fixed By chikaXSec404 & RzkyO
					 // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
		...
		case 'heroml':  
				...
				chika.sendMessage(from, buffer7, image, {quoted: iky, caption: teks})
				await limitAdd(sender)
				break
				case 'igvideo': 
                 if (!isRegistered) return reply( ind.noregis())
		...
		case 'grouplist':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					chika.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group FUJIWARA CHIKA :\n\n\`\`\``
					no = 0
					...
					chika.sendMessage(from, teks.trim(), extendedText, {quoted: iky})
					break
		//daftar 
		case 'daftar':
                			...
                			if (umurUser < 12) return reply(`your age is too young minimum 12 years`)
                    			...
                    			await chika.sendMessage(from, ppimg, image, {quoted: iky, caption: ind.registered(namaUser, umurUser, serialUser, time, sender)})
                    			addATM(sender)
...
◪ *TQTO:*
 ...
 ` 
		...
		case 'snk':
					me = chika.user
					uptime = process.uptime()
					teks = `*Syarat & Ketentuan FUJIWARA CHIKA*\n1. Teks dan nama pengguna WhatsApp anda kami simpan di dalam server selama bot aktif.\n2. Data anda akan di hapus ketika bot offline.\n3. Kami tidak menyimpan gambar, video, file, audio, dan dokumen yang anda kirim.\n4. Kami tidak pernah meminta anda untuk memberikan informasi pribadi.\n5. Jika menemukan Bug/Error silahkan langsung lapor ke Owner bot.\n6. Cukup perintah 1x jika bot tidak merespon harap ulangi kembali, Jika di ulangi kembali tidak merespon, Bot tidak aktif\n7. Dilarang spam, Share virus virtex, Telpon, Video call, Kami akan blockir anda.\n8. Apapun yang anda perintah pada bot ini, *KAMI TIDAK BERTANGGUNG JAWAB!*\n\nTERIMA KASIH !~`
					buffer = await getBuffer(me.imgUrl)
					chika.sendMessage(from, buffer, image, {caption: teks, contextInfo:{mentionedJid: [me.jid]}})
					break
		case 'lpr':
					const bug = body.slice(5)
					if (pesan.length > 300) return chika.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', msgType.text, {quoted: iky})
					...
					chika.sendMessage('6281227825649@s.whatsapp.net', options, text, {quoted: iky})
					reply('Masalah telah di laporkan ke owner Fujiwara Chika, Laporan palsu atau main² tidak akan ditanggapi.')
					break
		case 'request':
					const cfrr = body.slice(8)
					if (cfrr.length > 300) return chika.sendMessage(from, 'Maaf Teks Terlalu Panjang, Maksimal 300 Teks', msgType.text, {quoted: iky})
					var nomor = amv.participant
					...
					chika.sendMessage('6281227825649@s.whatsapp.net', options, text, {quoted: iky})
					chika.sendMessage('6281227825649@s.whatsapp.net', options, text, {quoted: iky})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER FUJIWARA CHIKA, Requests palsu atau main² tidak akan ditanggapi.')
					break
		case 'blocklist': 
					...
					chika.sendMessage(from, teks.trim(), extendedText, {quoted: iky, contextInfo: {"mentionedJid": blocked}})
					break
                case 'hidetag':
					 // Fix Bug By Sofyan AMV				
                 if (!isRegistered) return reply( ind.noregis())
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                                ...
                                const tagzz = {
                                        ...
                                        chika.sendMessage(from, tagzz, text, {quoted: iky})
					await limitAdd(sender)
                                        break
                                        case 'profile':
				...
				if (!isRegistered) return reply(ind.noregis())
					...
					chika.sendMessage(from, buffer, image, {quoted: iky, caption: profile})
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					buffer = await getBuffer(anu.result)
					chika.sendMessage(from, buffer, image, {caption: 'Nih anjim', quoted: iky})
					await limitAdd(sender)
					break
                case 'truth':
					 // Fix Bug By Sofyan AMV				
		...
		case 'quotesmotivasi':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
	                                const cangti = ['https://i.ibb.co/1T1DCz7/cewek-thailand-20200325-007-non-fotografer-kly.jpg','https://i.ibb.co/FsJ6jjs/kucing2.jpg','https://i.ibb.co/vvkdS7n/kucing3.jpg','https://i.ibb.co/1QHWxts/kucing4.jpg','https://i.ibb.co/JQmRz4n/kucing5.jpg','https://i.ibb.co/tBwrFkG/kucing6.jpg','https://i.ibb.co/dp0YhYm/kucing7.jpg','https://i.ibb.co/R03smZT/kucing8.jpg','https://i.ibb.co/17tw0dp/kucing9.jpg','https://i.ibb.co/7XdGGqc/kucing10.jpg','https://i.ibb.co/XL9PZxg/kucing11.jpg','https://i.ibb.co/gyjvXWN/kucing12.jpg','https://i.ibb.co/R4gg4wH/kucing13.jpg','https://i.ibb.co/PmLYtFm/kucing14.jpg','https://i.ibb.co/XbSDh47/kucing15.jpg','https://i.ibb.co/kSXNJzt/kucing16.jpg']
                                        ...
                                        chika.sendMessage(from, cangtip, image, {quote: iky})
					await limitAdd(sender)
                                        break
                /*case 'kucing':
					 // Fix Bug By Sofyan AMV				
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
	                                const kucings = ['https://i.ibb.co/vvmp82w/kucing1.jpg']
                                        ...
                                        chika.sendMessage(from, kucigz, image, {quote: iky})
					await limitAdd(sender)
                                        break*/
		case 'ssweb':
					 // Fix Bug By Sofyan AMV				
		...
		case 'waifu':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					chika.sendMessage(from, hasil, image, {quoted: iky})
					await limitAdd(sender)
					break
		case 'loli2':
					 // Fix Bug By Sofyan AMV				
		...
		case 'map':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					buffer = await getBuffer(anu.gambar)
					chika.sendMessage(from, buffer, image, {quoted: iky, caption: `${body.slice(5)}`})
					await limitAdd(sender)
					break
                case 'kbbi':
					 // Fix Bug By Sofyan AMV				
		...
		case 'quran':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					chika.sendMessage(from, quran, text, {quoted: iky})
					await limitAdd(sender)
					break
		case 'jadwalsholat':
					 // Fix Bug By Sofyan AMV				
				...
				if (args.length < 1) return reply('kota nya mana kak?')
					...
					chika.sendMessage(from, sholat, text, {quoted: iky})
					await limitAdd(sender)
					break
                case 'neonime':
				         // Fix Bug By Sofyan AMV				
		...
		case 'tts':
				...
				if (!isPremium) return reply('Maaf kamu bukan user premium!')
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				if (args.length < 1) return chika.sendMessage(from, 'Diperlukan kode bahasa kak!!', text, {quoted: iky})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return chika.sendMessage(from, 'Mana teks yang mau di jadiin suara? suara setan kah?', text, {quoted: iky})
					dtt = body.slice(8)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 300
					...
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							...
							buffer = fs.readFileSync(rano)
							if (err) return reply(ind.stikga())
							chika.sendMessage(from, buffer, audio, {quoted: iky, ptt:true})
							fs.unlinkSync(rano)
						})
					})
					await limitAdd(sender)
		...
		case 'tiktokstalk':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				try {
						if (args.length < 1) return chika.sendMessage(from, '*Username mana kak?', text, {quoted: iky})
				...
				chika.sendMessage(from, yeh, text, {quoted: iky})
				await limitAdd(sender)
				break
		case 'sayang':
		...
		case 'setpp': 
					...
					if (!isGroupAdmins) return reply(ind.admin())
                   			if (!isBotGroupAdmins) return reply(ind.badmin())
					media = await chika.downloadAndSaveMediaMessage(iky)
		...
		case 'group':
           ...
           /*case 'setname':
					...
					chika.sendMessage(from, 'Succes, Ganti Nama Grup', text, {quoted: iky})
					break*/
                /*case 'setdesc':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
					...
					chika.sendMessage(from, 'Succes, Ganti Deskripsi Grup', text, {quoted: iky})
					break*/
           /*case 'demote':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
		...
		case 'toimg':
				...
				if (!isQuotedSticker) return reply('*Reply/Tag sticker!*')
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						if (err) return reply(ind.stikga())
						buffer = fs.readFileSync(ran)
						chika.sendMessage(from, buffer, image, {quoted: iky, caption: '*DAH JADI SETAN* '})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender)
					break
				...
				case 'wait':
					...
					if ((isMedia && !amv.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await wait(media).then(res => {
							chika.sendMessage(from, res.video, video, {quoted: iky, caption: res.teks.trim()})
						}).catch(err => {
							reply(err)
						})
					} else {
		...
		if (budy.includes(`Bot`)) {
                  ...
                  reply(`Ya?\nUntuk Menggunakan Bot Ketik zmenu/zhelp`)
       ...
       if (budy.includes(`Sofyan`)) {

                  reply(`Jangan Panggil Sofyan Kak, Dia Lagi Sibuk ✨`)
