	...
	chika.on('message-new', async (amv) => {
		...
		case 'transfer':
              ...
              case 'soundbakahentai':
				...
				chika.sendMessage(from, aineess, audio, {mimetype: 'audio/mp4', filename: `bakahentai.mp3`, quoted: amv})
				await limitAdd(sender)
				break
              case 'sayonichan':
				 // Fix Bug By Sofyan AMV				
		...
		case 'vinta':
				...
				chika.sendMessage(from, vintage, image, {caption: 'nih anjim ${vin}', quoted: amv})
				await limitAdd(sender)
				break
		case 'avengers':
				 // Fix Bug By Sofyan AMV				
...
◪ *TQTO:*
 ...
 ` 
		...
		case 'lpr':
					...
					chika.sendMessage('6281227825649@s.whatsapp.net', options, text, {quoted: amv})
		...
		case 'blocklist': 
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					buffer = await getBuffer(anu.result)
					chika.sendMessage(from, buffer, image, {caption: 'Nih anjim', quoted: amv})
					await limitAdd(sender)
					break
                case 'truth':
					 // Fix Bug By Sofyan AMV				
